    ...
    try {
        ...
        if (pathname === "/api/portals/matrix" && method === "GET") {
            ...
            const matrix = [
                ...
                { name: "Cutshort", category: "India Tech", trust: "TRUSTED", oracleAccess: "PASS (HTTP 200)", executionMode: "Oracle VM Systemd", schedule: "11:30 AM & 3:30 PM IST", status: "ACTIVE_SCHEDULED", discoveryAutomation: "ACTIVE", appAutomation: "ACTIVE", indiaEligible: true, remoteEligible: true },
